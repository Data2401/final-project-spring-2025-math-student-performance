...
This project dives deep into a dataset from the [UCI Machine Learning Repository](https://www.kaggle.com/datasets/adilshamim8/math-students/data), which contains data on student performance in a secondary school math program. The dataset features academic, personal, and social aspects of a student's life.
