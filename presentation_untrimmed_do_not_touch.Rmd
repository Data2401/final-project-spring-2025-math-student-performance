...
The features (G1, G2, G3) represent period 1-3 of a school year (similar to a midterm in the United States being period 1/2 and finals being 2/2.) This is interesting because you can see if a student's score decreases over time (falling behind gradually due to external factors) or maintains a consistent grade throughout the year- these features also allow a ML model to predict G3 based off G1, G2, and the other external factors.

<br>

### Alcohol? Romance? Is that legal?

- Reality Check: Just because something is not legal doesn’t mean it doesn’t happen. We're trying to understand how real-life behaviors (like drinking or dating) might affect school performance.
- Cultural Context: The dataset is from Portugal, where norms can be a little different. For example, some families may introduce teens to alcohol in small, supervised amounts, especially during meals.
- Insight, Not Endorsement: Including this data doesn’t mean anyone’s encouraging it. It’s about spotting trends. Like—“Do students in relationships do better or worse in math?” or “Is there a pattern between alcohol use and test scores?”
...
### Do students from different schools show significant differences in final grade? INSIGNIFICANT
...
The IQR for MS is less spread out with failures bein outliers, but both schools' average is relatively in line with on another. The selection of school has no evidence of affecting student performance.
...
Students were more likely to do worse in math class if they drink during the week, rather than just on the weekends. 
