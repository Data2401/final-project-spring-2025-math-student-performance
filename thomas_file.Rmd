...
This project dives deep into a dataset from the UCI Machine Learning repository which contains data on student performance in a secondary school math program. The dataset contains features covering academic, personal, and social factors of a student's life.

Our goal is to determine what factor(s) have the most significant impact on student performance in the math program, as well as determine what factors have little to no affect on performance despite what intuition may lead the average person to believe. These factors have been divided into categories of:
