...
formatted %>%
  ...
  theme_linedraw() +
  labs(x = "Family Relationship (1-5)", fill = "Family Support", y = "Final Grade", title = "Family Educational Support and Relationship") # Optional: clearer labels
```

```{r study_internet_box, echo=FALSE, fig.align='center'}
...
long_grade_data %>% ggplot(aes(x = factor(study_time), y = grade)) +
